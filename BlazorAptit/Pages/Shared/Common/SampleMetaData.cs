    ...
    public class SampleMetaData : ComponentBase, IDisposable
    {
        ...
        private string GetContent()
        {
            ...
            if (SampleService.ComponentName != null)
            {
                ...
                sb.Append($"<title>");
                sb.Append("Blazor " + componentName + SampleUtils.SPACE + sampleName + " Example - Syncfusion Demos");
                sb.Append($"</title>");
                sb.Append(Environment.NewLine);
                sb.Append($"<meta");
                sb.Append($" name =\"description\"");
                sb.Append($" content =\"{"This example demonstrates the " + sampleName + " in Blazor " + componentName + " Component. Explore here for more details."}\"");
                sb.Append(">");
                sb.Append(Environment.NewLine);
            }
